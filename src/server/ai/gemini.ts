 ...
 *
 * Config: AI_PROVIDER=gemini, GEMINI_API_KEY=..., AI_MODEL=gemini-2.0-flash
 * Official REST API only. Advisory output; never applied to a draft without an
 * explicit user action (see src/app/drafts/actions.ts).
 */
